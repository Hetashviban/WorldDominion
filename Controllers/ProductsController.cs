...
namespace WorldDominion.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentId,Name,Description,MSRP")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DepartmentId,Name,Description,MSRP")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
